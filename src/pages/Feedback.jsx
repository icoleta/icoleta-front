    ...
    <div className="flex justify-center">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          <h1 className="sm:text-3xl text-4xl font-bold my-8 text-center text-4xl tracking-tight text-olive-green">
            Envie-nos um Feedback
          </h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            Esta é a primeira versão do sistema, então contamos com seu feedback
            para melhorar sua experiêcia no sistema.{" "}
          </p>
        </div>
            ...
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              ...
              <div className="flex text-center justify-center items-center">
                ...
                <span className="inline-flex">
                  <a
                    className="ml-4 text-olive-green  hover:text-olive-green-dark "
                    href="https://www.instagram.com/icoleta_sustentavel/"
                    target="_blank"
                  >
                    <svg
                      fill="none"
