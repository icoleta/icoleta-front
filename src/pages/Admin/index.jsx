    ...
    <main class="main-admin">
        ...
        <div class="bg-gray-100 sm:grid grid-cols-5 grid-rows-2 px-4 py-6 min-h-full space-y-6 sm:space-y-0 sm:gap-4">
            ...
            <div class="col-span-4 items-center"> 
                ...
                {/* Os componentes têm que aparecer aqui quando clicar no botao da nav bar */}
                <div>
    ...
    <div class="flex justify-center my-2 mx-4 md:mx-0">
        <form class="w-full  bg-white rounded-lg shadow-md p-6">
            ...
            <div class="flex w-full">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xt font-bold mb-2" for='Password'>Voluntário que coletou</label>
                        <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='password' required/>
                    </div>
                </div>
                    ...
                    <div class="flex w-full">
                        <div class="w-full md:w-full px-3 mb-6">
                            <label class="block uppercase tracking-wide text-gray-700 text-xt font-bold mb-2" for='Password'>Peso do resíduo</label>
                            <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='password' required/>
                        </div>

                        <div class="w-full md:w-full px-3 mb-6">
                            <label class="block uppercase tracking-wide text-gray-700 text-xt font-bold mb-2" for='Password'>Ponto de coleta</label>
                        <input class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none" type='password' required/>
                    </div>
                </div>
                ...
                <div class="flex items-center w-full mt-2">
                    <div class="w-6/12 md:w-1/3 px-3 pt-4 mx-2 ">
                        <button  title="Vidro" class='appearance-none flex items-center justify-center block w-full bg-gray-100 text-gray-700 shadow border border-gray-500 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none'>
                    ...
                    <div class="w-full md:w-1/3 px-3 pt-4 mx-2 border-t border-gray-400">
                        <button title="Plástico" class="appearance-none flex items-center justify-center block w-full bg-gray-100 text-gray-700 shadow border border-gray-500 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none">
                    ...
                    <div class="w-full md:w-1/3 px-3 pt-4 mx-2 ">
                        <button  title="Papel" class="appearance-none flex items-center justify-center block w-full bg-gray-100 text-gray-700 shadow border border-gray-500 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none">
                    ...
                    <div class="w-full md:w-1/3 px-3 pt-4 mx-2 border-t border-gray-400">
                        <button title="Metal" class="appearance-none flex items-center justify-center block w-full bg-gray-100 text-gray-700 shadow border border-gray-500 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none">
                    ...
                    <div class="w-full md:w-1/3 px-3 pt-4 mx-2 ">
                        <button title="Pilha" class="appearance-none flex items-center justify-center block w-full bg-gray-100 text-gray-700 shadow border border-gray-500 rounded-lg py-3 px-3 leading-tight hover:bg-gray-200 hover:text-gray-700 focus:outline-none">
            ...
            <div class="w-full md:w-full px-3 mb-6">
                <button class="appearance-none block w-full bg-olive-green hover:bg-olive-green-dark text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight  focus:outline-none focus:bg-white focus:border-gray-500">Coletar</button>
            </div>
        </form>
    </div>
                    ...
                    discards.map(discard => (
                        <>
                            <tr className="bg-white border-b">
                                ...
                                <td className="py-4 px-6">{new Date(discard.created_at).toLocaleString('pt-br')}</td>
            ...
            <div class="h-96 col-span-1 ">
                ...
                <div class="bg-white rounded-md">
                    ...
                    <div class="bg-white rounded-md list-none  text-center ">
                        <li class="py-3 rounded-lg border-b-2 hover:bg-sunset-orange"><a href="#" class="list-none">Resíduos</a></li>
                        <li class="py-3 rounded-lg border-b-2 hover:bg-sunset-orange"><a href="#" class="list-none">Entidades</a></li>
                        <li class="py-3 rounded-lg border-b-2 hover:bg-sunset-orange"><a href="#" class="list-none">Descartes</a></li>
                        <li class="py-3 rounded-lg hover:bg-sunset-orange"><a href="#" class="list-none">Usuários</a></li>
                    </div>
                </div>
            </div>
        </div>
