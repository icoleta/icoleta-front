...
const LoginUsuario = () => {
  ...
  return (
    <div className=" flex justify-center items-center bg-[#4B9093] h-screen w-full">
      <div className="flex flex-col justify-center items-center border rounded-[20px] shadow-sm m-8 h-[600px] w-[400px] 2xl:h-[600px] 2xl:w-[500px] bg-white ">
        <div className="flex flex-col justify-center items-center mb-[10px]">
          ...
          <h3 className="font-mulish font-regular text-[20px] 2xl:text-[30px] ">Acesso ao sistema</h3>
        </div>
        <form onSubmit={handleSubmit} className="flex flex-col items-center">
          <div className="flex flex-col mb-4">
            ...
            <div className="relative">
              <input
                ...
                errors={errors}
                className=" h-[48px] w-[280px] 2xl:w-[400px]  text-[14px] border-2 rounded-[10px] p-[12px] pl-[40px] focus:outline-[#F59A73]"
              /> 
          ...
          <button type="submit" className=" w-[280px] 2xl:w-[400px]  h-[48px] mt-[60px] bg-[#F59A73] border rounded-[10px] font-inter font-bold text-white text-[18px]  ">Entrar na plataforma</button>
        </form>
